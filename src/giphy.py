...
ff = FFmpeg(
	...
	outputs={'output.ts': ["-vf \"drawtext=fontfile=/usr/share/fonts/default/Type1/n019003l.pfb:text='hey': fontcolor=white: fontsize=24: box=1: boxcolor=black@0.5:boxborderw=5: x=(w-text_w)/2: y=(h-text_h)-2\" -an"}
)
ff.run()
